                  ...
                  <div class="card bg-light-subtle mt-4">
                    ...
                    <div class="card-body">
                      <div class="text-section">
                        <p class="card-title">
                          {place.place_type}{" "}
                          <span className="float-end">{place.city}</span>
                        </p>
                        <p class="card-text">{place.name}</p>
                        <p class="card-text mb-3">
                          <i class="la la-map-marker"></i>{" "}
                          {truncateAddress(place.address, 60)}
                        </p>
                      </div>
                      <div class="cta-section">
                        <div>
                          {place.avg_reviews > 0 ? (
                            <span>
                              <span style={{ color: "#23d3d3" }}>
                                <i class="la la-star"></i> {place.avg_reviews}
                              </span>{" "}
                        ...
                        <div className="d-flex justify-content-between">
                          <button
                            ...
                            onClick={() => BookingDeatils(place.id)}
                          >
                            Deatils
                          </button>
                          {place.status != "accepted" ? (
                            <button
                              ...
                              onClick={() => RemoveBooking(place.id)}
                            >
                              Cancel
                            </button>
                          ) : (
                            <span className="text-success mt-3">Accepted</span>
                          )}
                        </div>
                      </div>
                    </div>
