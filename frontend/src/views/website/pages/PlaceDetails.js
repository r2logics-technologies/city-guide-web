...
const PlaceDetails = () => {
  ...
  const onSubmit = async (data) => {
    ...
    formData.append(
      "total_adults",
      data.total_adults != null && data.total_adults
    );
    formData.append(
      "total_childs",
      data.total_childs != null && data.total_childs
    );
    formData.append(
      "booking_date",
      data.booking_date != null && data.booking_date
    );
    formData.append(
      "booking_time",
      data.booking_time != null && data.booking_time
    );
    api
      .post(url, formData)
      .then((res) => {
  ...
  const handlePayment = async () => {
    try {
      const response = await api.post('/api/razorpay-payment', { amount:place?.price_range });
      
      console.log(response)
      const options = {
        key: 'rzp_test_uvxPE36NLe26pz',
        amount: place?.price_range * 100,
        currency : 'INR',
        name: 'City Guide',
        image: logo_mini,
        ...
        handler: (response) => {
          api.post('/api/razorpay-verify', response)
            .then((verifyResponse) => {
        ...
        prefill: {
          ...
          contact: auth.user?.mobile.toString(),
        },
        notes: {
          address: 'coming soon ',
        },
    ...
    <div className="site-main single single-02">
      ...
      <div className="place">
        <div className="slick-sliders">
          ...
          >
            <div className="place-slider__item bd">
              <a title="Place Slider Image" href="#">
                <img
                  src={apiService.ledgerUrl + place.thumb}
                  alt={place.name}
                />
              </a>
            </div>
          ...
          <div className="place-share">
            {place.in_wishlist ? (
              <a
                ...
                onClick={() => RemoveWishlist(place.id)}
              >
          ...
          <div className="row mt-5">
            <div className="col-lg-8">
              <div className="place__left">
                <ul className="place__breadcrumbs breadcrumbs">
                  <li>
                    <a title={place.country} href="#">
                      {place.country}
                    </a>
                  </li>
                  <li>
                    <a title={place.city} href="#">
                      {place.city}
                    </a>
                  </li>
                  <li>
                    <a title={place.category} href="#">
                      {place.category}
                    </a>
                  </li>
                </ul>
                        ...
                        return (
                          <div className="col-md-2">
                            <div className="place__amenities mb-4">
                              <img
                                src={apiService.ledgerUrl + amenitie.icon}
                                alt="Free wifi"
                              />
                ...
                <div className="place__box place__box-open">
                  <h3 className="place__title--additional">Opening Hours</h3>
                          ...
                          <div className="place__author">
                            <div className="place__author__avatar">
                              <a title="Sebastian" href="#">
                                <img
                                  src={
                                    apiService.ledgerUrl + review.customer.image
                                  }
                                  alt=""
                                />
                              </a>
                      ...
                      <form onSubmit={handleSubmit2(onReview)}>
                        ...
                        <div className="field-textarea">
                          <img
                            ...
                            src={apiService.ledgerUrl + auth_user.avatar}
                            alt=""
                          />
                          <textarea
                            {...register2("review")}
            ...
            <div className="col-lg-4">
              {auth.token ? (
                  ...
                  <div className="card">
                    <div className="card-body">
                      <form onSubmit={handleSubmit(onSubmit)}>
                        ...
                        <div>
                          <label for="adults" className="form-label">
                            Total Adults
                          </label>
                          <input
                            type="number"
                            {...register("total_adults", { required: true })}
                        ...
                        <div className="mt-2">
                          <label for="Childrens" className="form-label">
                            Total Childrens
                          </label>
                          <input
                            type="number"
                            {...register("total_childs", { required: true })}
                            className="form-control"
                            id="Childrens"
                        ...
                        <div className="mt-2">
                          ...
                          <input
                            type="time"
                            {...register("booking_time", { required: true })}
                            className="form-control"
                            id="Time"
                          />
                          <small className="text-danger">
                ...
                <p>
                  <Link to={"/login"}>Login</Link> For Booking
                </p>
              )}
            </div>
          </div>
